...
export interface Env {
  ...
  // ---------------------------------------------------------------
  // 以下已从 Env 移除，统一从 DB system_config 读取：
  // ALLOW_REGISTRATION, MIN/MAX_USERNAME_LENGTH, MIN/MAX_PASSWORD_LENGTH
  // MAX_FAVORITES_PER_USER, MAX_HISTORY_PER_USER, MAX_TAGS_PER_USER
  // COMMUNITY_MAX_SHARES_PER_USER, COMMUNITY_REQUIRE_APPROVAL
  // EMAIL_VERIFICATION_ENABLED, EMAIL_VERIFICATION_REQUIRED
  // VERIFICATION_CODE_LENGTH, VERIFICATION_CODE_EXPIRY
  // MAX_VERIFICATION_ATTEMPTS, EMAIL_RATE_LIMIT_PER_HOUR/DAY
  // ENABLE_SOURCE_STATUS_CHECK, SOURCE_STATUS_CHECK_TIMEOUT
  // SOURCE_STATUS_CACHE_DURATION
  // ---------------------------------------------------------------
}
