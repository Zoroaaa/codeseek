...
const DEFAULT_CONFIG_VALUES: Record<string, { value: string; description: string; configType: string; configGroup: string; isPublic: number; isSensitive: number; validationRules?: string }> = {
  ...
  'forgot_password_enabled': { value: '1', description: '是否启用忘记密码功能', configType: 'boolean', configGroup: 'features', isPublic: 1, isSensitive: 0 },
  'community_enabled': { value: '1', description: '启用搜索源共享社区功能', configType: 'boolean', configGroup: 'features', isPublic: 1, isSensitive: 0 },
  'community_require_approval': { value: '0', description: '新分享的搜索源需要审核', configType: 'boolean', configGroup: 'features', isPublic: 0, isSensitive: 0 },
  'email_verification_enabled': { value: '1', description: '是否启用邮箱验证功能', configType: 'boolean', configGroup: 'features', isPublic: 1, isSensitive: 0 },
  'email_verification_required': { value: '0', description: '注册时是否强制邮箱验证', configType: 'boolean', configGroup: 'features', isPublic: 1, isSensitive: 0 },
