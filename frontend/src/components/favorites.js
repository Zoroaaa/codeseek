    ...
    return `
      <div class="favorite-item" data-id="${favorite.id}">
        ...
        <div class="favorite-actions">
          <button class="action-btn visit-btn" onclick="favoritesManager.openFavorite('${escapeHtml(favorite.url)}')">
            访问
          </button>
          <button class="action-btn copy-btn" onclick="favoritesManager.copyFavoriteUrl('${escapeHtml(favorite.url)}')">
            复制
          </button>
          <button class="action-btn remove-btn" onclick="favoritesManager.removeFavorite('${favorite.id}')">
            删除
          </button>
        </div>
      </div>
