      ...
      <div className="max-w-3xl mx-auto px-4 py-12 relative">
        ...
        <div className="rounded-2xl bg-white dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-700/50 p-7 sm:p-8 shadow-soft-lg">
          ...
          <div className="space-y-6 text-sm sm:text-base text-slate-700 dark:text-slate-300 leading-relaxed">
            <div>
              <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-3">1. 我们重视你的隐私</h2>
              <p>
            ...
            <div>
              <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-3">2. 我们收集什么信息</h2>
            ...
            <div>
              <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-3">3. 我们如何使用这些信息</h2>
              <ul className="list-disc pl-5 space-y-2">
                <li>提供和改进我们的搜索服务</li>
                <li>验证你的身份，确保账号安全</li>
                <li>发送重要通知（比如验证码）</li>
            ...
            <div>
              <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-3">4. 我们不会分享你的信息</h2>
              <p>
            ...
            <div>
              <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-3">5. 我们如何保护你的信息</h2>
              <p>
            ...
            <div>
              <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-3">6. 数据保留</h2>
              <p>
            ...
            <div>
              <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-3">7. 你的权利</h2>
              <ul className="list-disc pl-5 space-y-2">
                <li>访问和查看你的个人信息</li>
                <li>修改或删除你的个人信息</li>
                <li>注销你的账号</li>
            ...
            <div>
              <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-3">8. 政策可能会更新</h2>
              <p>
